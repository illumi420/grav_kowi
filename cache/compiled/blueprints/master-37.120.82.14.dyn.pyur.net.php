...
return [
    ...
    'timestamp' => 1728135465,
    'checksum' => '7fead63fa947c370f95fdc1be23f9307',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/image-collage' => [
                'file' => 'user/plugins/image-collage/blueprints.yaml',
                'modified' => 1727808828
            ],
            ...
            'plugins/fullcalendar' => [
                'file' => 'user/plugins/fullcalendar/blueprints.yaml',
                'modified' => 1727206611
            ]
        ],
        'user/themes' => [
            'themes/cacti' => [
                'file' => 'user/themes/cacti/blueprints.yaml',
                'modified' => 1727205808
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.image-collage.enabled' => [
                ...
                'name' => 'plugins.image-collage.enabled',
                'validation' => 'strict'
            ],
            'plugins.image-collage.column' => [
                'type' => 'text',
                'size' => 'x-small',
                ...
                'name' => 'plugins.image-collage.column',
                'validation' => 'strict'
            ],
            'plugins.image-collage.border_size' => [
                'type' => 'text',
                'size' => 'x-small',
                'label' => 'Border size',
                'default' => 10,
                ...
                'name' => 'plugins.image-collage.border_size',
                'validation' => 'strict'
            ],
            'plugins.image-collage.image_width' => [
                'type' => 'text',
                'size' => 'x-small',
                ...
                'name' => 'plugins.image-collage.image_width',
                'validation' => 'strict'
            ],
            'plugins.flex-objects' => [
                'type' => '_root',
            ...
            'plugins.fullcalendar.enabled' => [
                ...
                'name' => 'plugins.fullcalendar.enabled'
            ],
            'plugins.fullcalendar.showlegend' => [
                'type' => 'toggle',
                'label' => 'Show Legend(s)',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.fullcalendar.showlegend'
            ],
            'plugins.fullcalendar.weekNumbers' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.fullcalendar.weekNumbers'
            ],
            'plugins.fullcalendar.colors' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Calendar(s) Colors',
                'name' => 'plugins.fullcalendar.colors'
            ],
            'plugins.fullcalendar.cors_api_url' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'local Cors API URL',
                'default' => NULL,
                'name' => 'plugins.fullcalendar.cors_api_url'
            ],
            'plugins.fullcalendar.enableDescPopup' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.fullcalendar.enableDescPopup'
            ],
            'plugins.fullcalendar.useIcsTimezone' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.fullcalendar.useIcsTimezone'
            ],
            'plugins.fullcalendar.tz_offset_single' => [
                'type' => 'number',
                'size' => 'small',
                'label' => 'Time Offset (hours) to correct single Events',
                'default' => 0,
                'name' => 'plugins.fullcalendar.tz_offset_single'
            ],
            'plugins.fullcalendar.tz_offset_minutes' => [
                'type' => 'number',
                'size' => 'small',
                ...
                'name' => 'plugins.fullcalendar.tz_offset_minutes'
            ],
            'plugins.fullcalendar.tz_offset_rec' => [
                'type' => 'number',
                'size' => 'small',
                'label' => 'Time Offset (hours) to correct recurring Events',
                'default' => 0,
                'name' => 'plugins.fullcalendar.tz_offset_rec'
            ],
            'plugins.fullcalendar.firstWeekDay' => [
                'type' => 'number',
                'size' => 'small',
                'label' => 'first Day of Week',
                'default' => 0,
                'name' => 'plugins.fullcalendar.firstWeekDay'
            ],
            'themes.cacti' => [
                'type' => '_root',
                'form_field' => false,
            ...
            'themes.cacti.author' => [
                ...
                'name' => 'themes.cacti.author',
                'validation' => 'loose'
            ],
            'themes.cacti.title_header' => [
                'type' => 'toggle',
                'label' => 'Title Header',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'themes.cacti.title_header',
                'validation' => 'loose'
            ],
            'themes.cacti.home_profile' => [
                'type' => 'toggle',
                'label' => 'Home Profile',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.cacti.home_profile',
                'validation' => 'loose'
            ],
            'themes.cacti.infinite_scroll' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.cacti.infinite_scroll',
                'validation' => 'loose'
            ],
            'themes.cacti.analytics' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'themes.cacti.analytics',
                'validation' => 'loose'
            ],
            'themes.cacti.social' => [
                'type' => '_parent',
                'name' => 'themes.cacti.social',
                'form_field' => false
            ],
            'themes.cacti.social.twitter' => [
                'type' => 'text',
                'size' => 'medium',
                'label' => 'Twitter',
                'default' => '@getgrav',
                ...
                'name' => 'themes.cacti.social.twitter',
                'validation' => 'loose'
            ],
            'themes.cacti.social.facebook' => [
                'type' => 'text',
                'size' => 'medium',
                'label' => 'Facebook',
                'default' => 'rockettheme',
                ...
                'name' => 'themes.cacti.social.facebook',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'image-collage' => [
                    'enabled' => 'plugins.image-collage.enabled',
                    'column' => 'plugins.image-collage.column',
                    'border_size' => 'plugins.image-collage.border_size',
                    'image_width' => 'plugins.image-collage.image_width'
                ],
                'flex-objects' => [
                ...
                'fullcalendar' => [
                    'enabled' => 'plugins.fullcalendar.enabled',
                    'showlegend' => 'plugins.fullcalendar.showlegend',
                    'weekNumbers' => 'plugins.fullcalendar.weekNumbers',
                    'colors' => 'plugins.fullcalendar.colors',
                    'cors_api_url' => 'plugins.fullcalendar.cors_api_url',
                    'enableDescPopup' => 'plugins.fullcalendar.enableDescPopup',
                    'useIcsTimezone' => 'plugins.fullcalendar.useIcsTimezone',
                    'tz_offset_single' => 'plugins.fullcalendar.tz_offset_single',
                    'tz_offset_minutes' => 'plugins.fullcalendar.tz_offset_minutes',
                    'tz_offset_rec' => 'plugins.fullcalendar.tz_offset_rec',
                    'firstWeekDay' => 'plugins.fullcalendar.firstWeekDay'
                ]
            ],
            'themes' => [
                'cacti' => [
                    'author' => 'themes.cacti.author',
                    'title_header' => 'themes.cacti.title_header',
                    'home_profile' => 'themes.cacti.home_profile',
                    'infinite_scroll' => 'themes.cacti.infinite_scroll',
                    'analytics' => 'themes.cacti.analytics',
                    'social' => [
                        'twitter' => 'themes.cacti.social.twitter',
                        'facebook' => 'themes.cacti.social.facebook'
                    ]
                ],
                'quark' => [
