...
return [
    ...
    'timestamp' => 1728497652,
    'checksum' => 'f722d93ecc7a3ec062092b6293b56404',
    'files' => [
        'user/maher.ddns.berlin/config' => [
            'plugins/aboutme' => [
                'file' => 'user/maher.ddns.berlin/config/plugins/aboutme.yaml',
                'modified' => 1727808727
            ],
            'plugins/darkskyweather' => [
                'file' => 'user/maher.ddns.berlin/config/plugins/darkskyweather.yaml',
                'modified' => 1727206274
            ],
            'plugins/datetools' => [
                'file' => 'user/maher.ddns.berlin/config/plugins/datetools.yaml',
                'modified' => 1727808714
            ],
            'plugins/fullcalendar' => [
                'file' => 'user/maher.ddns.berlin/config/plugins/fullcalendar.yaml',
                'modified' => 1727206849
            ],
            'security' => [
                'file' => 'user/maher.ddns.berlin/config/security.yaml',
                'modified' => 1727205395
            ],
            'system' => [
                'file' => 'user/maher.ddns.berlin/config/system.yaml',
                'modified' => 1727205861
            ],
            'themes/quark' => [
                'file' => 'user/maher.ddns.berlin/config/themes/quark.yaml',
                'modified' => 1727205865
            ]
        ],
        'user/config' => [
        ...
        'user/plugins' => [
            ...
            'plugins/fullcalendar' => [
                'file' => 'user/plugins/fullcalendar/fullcalendar.yaml',
                'modified' => 1727206611
            ]
        ],
        'user/themes' => [
            'themes/cacti' => [
                'file' => 'user/themes/cacti/cacti.yaml',
                'modified' => 1727205808
            ],
            'themes/quark' => [
    ...
    'data' => [
        ...
        'plugins' => [
            ...
            'fullcalendar' => [
                ...
                'weekNumbers' => false,
                'cors_api_url' => NULL,
                'useIcsTimezone' => false,
                'enableDescPopup' => true,
                'tz_offset_single' => 0,
                'tz_offset_rec' => 0,
            ...
            'darkskyweather' => [
                ...
                'caption' => 'Weather',
                'refreshtime' => 60,
                'api_key' => 'Q3WsB4exmMaQR5TknY094D44swSJZCKR',
                'latitude' => 53.108179743512,
                'longitude' => 13.904925051244
            ]
        ],
        'backups' => [
            'purge' => [
